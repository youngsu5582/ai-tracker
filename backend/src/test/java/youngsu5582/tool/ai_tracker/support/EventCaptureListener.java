...
public class EventCaptureListener extends AbstractTestExecutionListener {
    ...
    @Override
    public void afterTestClass(org.springframework.test.context.@NotNull TestContext testContext) {
        eventList.clear();
    }

    @Override
    public void beforeTestClass(org.springframework.test.context.@NotNull TestContext testContext) {
        eventList.clear();
    }
}
